...
import { FilePicker, Dialog, Pane, Text, Button, Icon, Spinner, TextInputField } from 'evergreen-ui'
import { Mutation } from 'react-apollo'
import { CREATE_ITEM_MUTATION, UPDATE_ITEM_MUTATION } from '../../graphql/mutations'
...
class CreateItemModal extends Component {
	state = {
		...
		largeImage: this.props.largeImage || 'https://via.placeholder.com/250x250',
	...
	render() {
		...
		const { title, description, image, price, largeImage, editMode } = this.state
